...
class IG_API:
    ...
    def authenticate(cls):
        ...
        try:
            ...
            logging.error(f"❌ IG API exception: {e}")
            cls.CST, cls.SECURITY_TOKEN = None, None
...
def log_transaction(order_id, status, platform_response):
    ...
    logging.info(log_message)
if __name__ == "__main__":
    logging.info("✅ Trading script started (SIMULATION_MODE = %s)", os.getenv("SIMULATION_MODE"))

    # 測試執行假交易
    execute_trade("Binance", "BTCUSDT", "BUY", 0.01, 70000)
